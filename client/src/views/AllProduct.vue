<template>
  <div>
    ...
    <v-item-group class="pa-5 content">
      <v-container>
        <v-row>
          <v-col
          ...
          >
            <v-item v-slot:default="{ active, toggle }">
              <v-card
                ...
                @click="toggle"
              >
                <v-img class="white--text align-end" height="200px" :src="product.image_url"></v-img>
                ...
                <v-card-actions>
                  <v-btn color="primary" text @click="editItem(product)">
                    <v-icon>mdi-pencil</v-icon>
                  </v-btn>
                  <v-spacer></v-spacer>
                  <v-btn color="error" text @click="deleteItem(product)">
